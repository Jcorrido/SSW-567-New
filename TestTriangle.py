...
# My Test cases below
    ...
    def testInvalidTriangles(self):
        self.assertEqual(classifyTriangle(1, 1, 'a'), 'InvalidInput', '1,1,a should be InvalidInput')
        ...
        self.assertEqual(classifyTriangle(2, 1, 1), 'InvalidInput', '2,1,1 should be InvalidInput')
